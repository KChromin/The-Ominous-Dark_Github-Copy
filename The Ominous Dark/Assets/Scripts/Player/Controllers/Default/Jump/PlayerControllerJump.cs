...
namespace NOS.Player.Controller.Default
{
    public class PlayerControllerJump : ControllerBase
    {
        ...
        public PlayerControllerJump(InputDataContainer input, PlayerConditions conditions, PlayerReferences references, PlayerActions playerActions)
        {
            _input = input;
        ...
        private void TryToExecuteJump()
        {
            ...
            if (!_cases.isGrounded && !ShouldCoyoteJump()) return;
        ...
        {
            await UniTask.WaitForSeconds(_parameters.failedJumpCaseResetTimeInSeconds, cancellationToken: _cts.Token, cancelImmediately: true);
