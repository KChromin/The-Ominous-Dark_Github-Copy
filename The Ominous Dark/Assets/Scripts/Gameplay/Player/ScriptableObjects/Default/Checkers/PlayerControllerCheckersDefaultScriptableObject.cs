...
namespace NOS.Player.Controller.Default
{
    ...
    public class PlayerControllerCheckersDefaultScriptableObject : ScriptableObject
    {
        ...
        [Header("Slope Check - Move in direction of slope")]
        public float slopeCheckDirectionVerticalOffset;
        public float slopeCheckDirectionDistance = 0.05f;
        public float slopeCheckDirectionRadius = 0.26f;
